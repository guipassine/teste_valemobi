...
<html>
    ...
    <body>
        <main id="interface">
            ...
            <div id="content">
                <h4>NOVO TIPO DE NEGÓCIO</h4>
                <br />
                <form role="form" action="create_tipo_negocio.php" method="post">
                    <div class="form-group">
                        <label for="tipo_negocio">Tipo Negócio</label>
                        <input required class="form-control" id="tipo_negocio" name="tipo_negocio" placeholder="Digite aqui..." />
                    </div>
